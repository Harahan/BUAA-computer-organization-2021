...
`define alu_movz 5'd12
`define alu_jap 5'd13
...
`define op_bltzal 6'h1//conditionally in mars , defferent in instructions!!!
`define op_bgezal 6'h1
`define rt_bgezal 5'h11
`define op_special_2 6'h1c
`define func_msub 6'h4
`define func_msubu 6'h5
`define func_movz 6'ha

//课上第一次
`define op_lwer 6'h35
`define op_jap 6'h36
`define func_shl 6'h34

//往年
`define op_lhonez 6'h33
